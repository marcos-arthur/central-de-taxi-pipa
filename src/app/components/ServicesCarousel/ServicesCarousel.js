...
export default function ServicesCarousel(){
    ...
    return(
        <>
            <Carousel variant="dark" className={styles.myCarousel} activeIndex={index} onSelect={handleSelect} indicators={false} touch={true} prevIcon={<ChevronLeft size={50} color={"#00B0D5"}/>} nextIcon={<ChevronRight size={50} color={"#00B0D5"}/>}>
